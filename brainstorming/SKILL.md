...
7. **Spec self-review** — quick inline check for placeholders, contradictions, ambiguity, scope (see below). Optionally, dispatch spec reviewer subagent using `spec-document-reviewer-prompt.md` for thorough review.
